...
<div class="card border-success mb-3" style="width: 18rem; margin-top: 10px;">
...
<div class="card-body">
  ...
  <p class="card-text"> 
ປະເພດ:  <?php echo $row_pro['type_name']; ?>
  </p>
  <a href="product_detail.php?id=<?php echo $row_pro['p_id'] ?>" class="btn btn-primary"> ລາຍລະອຽດ </a>
</div>
</div>
<?php } ?>
</div>