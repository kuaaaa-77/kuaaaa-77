  ...
  <div class="row">
      <form  name="addproduct" action="product_form_edit_db.php" method="POST" enctype="multipart/form-data"  class="form-horizontal">
        <div class="form-group">
          <div class="col-sm-9">
            <p> ຊື່ສິນຄ້າ</p>
            <input type="text"  name="p_name" class="form-control" required placeholder="ຊື່ສິນຄ້າ" / value="<?php echo $p_name; ?>">
          </div>
        </div>
         <div class="form-group">
          <div class="col-sm-6">
        ...
        <div class="form-group">
          <div class="col-sm-12">
            ...
            <button type="submit" class="btn btn-success" name="btnadd"> ບັນທືກ </button>
