...
<div class="form-group">
          ...
          <div class="form-group">
            <div class="col-sm-6" align="left">
              <input  name="a_name" type="text" required class="form-control" id="a_name" value="<?=$a_name;?>" placeholder="ຊື່ແລະນາມສະກຸນ" />
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6" align="right">
              <button type="submit" class="btn btn-success byn-sm" id="btn"> <span class="glyphicon glyphicon-saved"></span> ບັນທືກ  </button>      
            </div> 
          </div>
        </form>