...
<form  name="register" action="member_form_edit_db.php" method="POST" class="form-horizontal">
       ...
       <input type="hidden" name="member_id" value="<?php echo $member_id; ?>">
        ...
        <div class="form-group">
          <div class="col-sm-5" align="left">
            <input  name="m_name" type="text" required class="form-control" id="m_name" value="<?=$m_name;?>" placeholder="ຊື່ແລະນາມສະກຸນ " />
          </div>
        </div>
        <div class="form-group">
          <div class="col-sm-5" align="left">
            <input  name="m_email" type="email" class="form-control" id="m_email" value="<?=$m_email;?>" placeholder=" ອີເມວ name@hotmail.com"/>
          </div>
        </div>
        <div class="form-group">
          <div class="col-sm-5" align="left">
            <input  name="m_tel" type="text" class="form-control" id="m_tel" value="<?=$m_tel;?>" placeholder="ເບີໂທ" />
          </div>
        </div>
        <div class="form-group">
          <div class="col-sm-5" align="left">
      ...
      <div class="form-group">
          ...
          <button type="submit" class="btn btn-success" id="btn"><span class="glyphicon glyphicon-ok"></span> ແກ້ໄຂ  </button>
          </div>     
      </div>
      </form>