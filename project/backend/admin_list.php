...
$(document).ready(function() {
  ...
  <?php do { ?>
    ...
    <tr>
      ...
      <td><a href="admin.php?act=edit&ID=<?php echo $row_am['a_id']; ?>" class="btn btn-warning btn-sm"> ແກ້ໄຂ </a> </td>
       <td><a href="admin_form_delete_db.php?ID=<?php echo $row_am['a_id']; ?>" class='btn btn-danger btn-sm'  onclick="return confirm('ຢືນຍັນການລົບ')">ລົບ</a> </td>
    </tr>
